...
var TRANSLATIONS = {
  ...
  btn_reset: "Réinitialiser",
    ...
    toggle_allow_db_update_off: 'BDD protégée — mise à jour automatique désactivée (recommandé)',
    toggle_allow_db_update_on:  'BDD — mise à jour automatique ACTIVÉE (vérifiez le backup !)',
    toggle_allow_db_update_hint: 'Autoriser la mise à jour automatique de cette base de données',
...
6. LICENCE
   ...
   https://github.com/Parralex-Labs/Unraid-Docker-Orchestrator`,
    ...
    settings_tab_timeouts: 'Timeouts containers',
    settings_global_timeout: 'Timeout global (s)',
    settings_boot_delay: 'Délai boot (s)',
    settings_abort_on_failure: 'Arrêter si timeout',
    settings_log_refresh: 'Auto-refresh logs (s)',
    settings_collapse_classify: 'Replier après classification',
    settings_default_pause: 'Pause entre groupes (s)',
    settings_save: 'Sauvegarder',
    settings_saved: 'Paramètres sauvegardés',
    settings_ct_name: 'Container',
    settings_ct_timeout: 'Timeout (s)',
    settings_ct_add: '+ Ajouter',
    settings_ct_detect: '🔍 Détecter depuis logs',
    settings_ct_detect_none: 'Aucun timeout détecté dans le dernier log.',
    settings_ct_detected: 'timeout(s) détecté(s) — valeurs suggérées ci-dessous.',
    tab_logs: '📋 Logs',
    log_viewer_title: 'Logs d\'exécution des scripts',
    log_select_start: '🚀 Démarrage',
    log_select_stop: '🛑 Arrêt',
    log_select_update: '🔄 Mise à jour',
    log_btn_refresh: 'Actualiser',
    log_btn_clear: 'Effacer',
    log_status_running: 'En cours...',
    log_status_ok: 'Terminé',
    log_status_error: 'Terminé avec erreurs',
    log_empty: 'Aucun log disponible pour ce script.',
    log_auto_refresh: 'Auto-actualisation',
    ...
    pool_picker_manual: 'Saisir un nom manuellement…',
    ...
    dep_picker_title: 'Choisir une dépendance',
    dep_picker_search: 'Rechercher un conteneur...',
    dep_picker_group: 'Groupe',
    dep_picker_already: 'Déjà une dépendance',
    dep_picker_empty: 'Aucun conteneur disponible',
    dep_picker_no_results: 'Aucun résultat',
    lbl_db_group: 'Base de données',
    lbl_hub: 'Dépendance cible',
    lbl_source: 'Source',
    lbl_deps_count_plural: 'dépendances',
    lbl_deps_count_singular: 'dépendance',
    ...
    autostart_modal_title: "Conflit de démarrage détecté",
    autostart_modal_body: "Le démarrage automatique Docker d'Unraid est actif en même temps que les scripts UDO. Au boot, les deux systèmes tenteront de démarrer les conteneurs simultanément, provoquant des conflits imprévisibles.",
    autostart_modal_warn: "Il est fortement recommandé de désactiver le démarrage automatique Unraid et de laisser UDO gérer seul l'ordre de démarrage.",
    autostart_modal_disable: "Désactiver le démarrage automatique Unraid",
    autostart_modal_ignore: "Ignorer (non recommandé)",
    autostart_modal_ignore_warn: "⚠ UDO et le démarrage automatique Unraid seront actifs simultanément. Des conflits sont possibles au prochain démarrage.",
    autostart_disabled_ok: "Démarrage automatique Unraid désactivé avec succès",
  },
    autostart_modal_body_container: "1 conteneur a son démarrage automatique Unraid activé.",
    autostart_modal_body_containers: function(n){ return n + " conteneurs ont leur démarrage automatique Unraid activé."; },
    autostart_modal_body_conflict: "Au boot, Unraid tentera de les démarrer <em>en même temps</em> qu'UDO. Cela provoque des conflits imprévisibles.",
  en: {
...
6. LICENSE
   ...
   https://github.com/Parralex-Labs/Unraid-Docker-Orchestrator`,
    ...
    settings_tab_timeouts: 'Container timeouts',
    settings_global_timeout: 'Global timeout (s)',
    settings_boot_delay: 'Boot delay (s)',
    settings_abort_on_failure: 'Stop on timeout',
    settings_log_refresh: 'Log auto-refresh (s)',
    settings_collapse_classify: 'Collapse after classification',
    settings_default_pause: 'Pause between groups (s)',
    settings_save: 'Save',
    settings_saved: 'Settings saved',
    settings_ct_name: 'Container',
    settings_ct_timeout: 'Timeout (s)',
    settings_ct_add: '+ Add',
    settings_ct_detect: '🔍 Detect from logs',
    settings_ct_detect_none: 'No timeout detected in last log.',
    settings_ct_detected: 'timeout(s) detected — suggested values below.',
    tab_logs: '📋 Logs',
    log_viewer_title: 'Script execution logs',
    log_select_start: '🚀 Startup',
    log_select_stop: '🛑 Stop',
    log_select_update: '🔄 Update',
    log_btn_refresh: 'Refresh',
    log_btn_clear: 'Clear',
    log_status_running: 'Running...',
    log_status_ok: 'Completed',
    log_status_error: 'Completed with errors',
    log_empty: 'No log available for this script.',
    ...
    pool_picker_manual: 'Type a name manually…',
    ...
    dep_picker_title: 'Choose a dependency',
    dep_picker_search: 'Search container...',
    dep_picker_group: 'Group',
    dep_picker_already: 'Already a dependency',
    dep_picker_empty: 'No container available',
    dep_picker_no_results: 'No results',
    lbl_db_group: 'Database',
    lbl_hub: 'Dependency target',
    lbl_source: 'Source',
    lbl_deps_count_plural: 'dependencies',
    lbl_deps_count_singular: 'dependency',
    ...
    toggle_allow_db_update_off: 'DB protected — auto-update disabled (recommended)',
    toggle_allow_db_update_on:  'DB — auto-update ENABLED (check backup first!)',
    toggle_allow_db_update_hint: 'Allow automatic update of this database',
    ...
    autostart_modal_title: "Startup conflict detected",
    autostart_modal_body_container: "1 container has its Unraid autostart individually enabled.",
    autostart_modal_body_containers: function(n){ return n + " containers have their Unraid autostart individually enabled."; },
    autostart_modal_body_conflict: "At boot, Unraid will attempt to start them <em>at the same time</em> as UDO. This causes unpredictable conflicts.",
    autostart_modal_body: "Unraid's Docker autostart is enabled alongside UDO scripts. At boot, both systems will attempt to start your containers simultaneously, causing unpredictable conflicts.",
    autostart_modal_warn: "It is strongly recommended to disable Unraid autostart and let UDO manage the startup order on its own.",
    autostart_modal_disable: "Disable Unraid autostart",
    autostart_modal_ignore: "Ignore (not recommended)",
    autostart_modal_ignore_warn: "⚠ UDO and Unraid autostart will both be active. Conflicts may occur at next boot.",
    autostart_disabled_ok: "Unraid autostart successfully disabled",
  },
  es: {
...
6. LICENCIA
   ...
   https://github.com/Parralex-Labs/Unraid-Docker-Orchestrator`,
    ...
    settings_title: 'Ajustes del plugin',
    settings_tab_general: 'General',
    settings_tab_timeouts: 'Timeouts containers',
    settings_global_timeout: 'Timeout global (s)',
    settings_boot_delay: 'Retraso inicio (s)',
    settings_abort_on_failure: 'Detener si timeout',
    settings_log_refresh: 'Auto-refresh logs (s)',
    settings_collapse_classify: 'Colapsar tras clasificación',
    settings_default_pause: 'Pausa entre grupos (s)',
    settings_save: 'Guardar',
    settings_saved: 'Ajustes guardados',
    settings_ct_name: 'Contenedor',
    settings_ct_timeout: 'Timeout (s)',
    settings_ct_add: '+ Añadir',
    settings_ct_detect: '🔍 Detectar desde logs',
    settings_ct_detect_none: 'Sin timeout detectado en el último log.',
    settings_ct_detected: 'timeout(s) detectado(s) — valores sugeridos abajo.',
    tab_logs: '📋 Logs',
    log_viewer_title: 'Logs de ejecución de scripts',
    log_select_start: '🚀 Inicio',
    log_select_stop: '🛑 Parada',
    log_select_update: '🔄 Actualización',
    log_btn_refresh: 'Actualizar',
    log_btn_clear: 'Limpiar',
    log_status_running: 'En curso...',
    log_status_ok: 'Completado',
    log_status_error: 'Completado con errores',
    log_empty: 'No hay log disponible para este script.',
    log_auto_refresh: 'Auto-actualización',
    ...
    pool_picker_manual: 'Escribir un nombre manualmente…',
    lbl_stack_compose: 'Stack compose: ',
    ...
    dep_picker_title: 'Elegir una dependencia',
    dep_picker_search: 'Buscar contenedor...',
    dep_picker_group: 'Grupo',
    dep_picker_already: 'Ya es dependencia',
    dep_picker_empty: 'No hay contenedores disponibles',
    dep_picker_no_results: 'Sin resultados',
    lbl_db_group: 'Base de datos',
    lbl_hub: 'Dependencia destino',
    lbl_source: 'Origen',
    lbl_deps_count_plural: 'dependencias',
    lbl_deps_count_singular: 'dependencia',
    ...
    toggle_allow_db_update_off: 'BD protegida — actualización automática desactivada (recomendado)',
    toggle_allow_db_update_on:  'BD — actualización automática ACTIVADA (¡verifique el backup!),',
    toggle_allow_db_update_hint: 'Permitir actualización automática de esta base de datos',
    ...
    autostart_modal_body_container: "1 contenedor tiene el inicio automático de Unraid activado individualmente.",
    autostart_modal_body_containers: function(n){ return n + " contenedores tienen el inicio automático de Unraid activado individualmente."; },
    autostart_modal_body_conflict: "Al arrancar, Unraid intentará iniciarlos <em>al mismo tiempo</em> que UDO. Esto provoca conflictos imprevisibles.",
    ...
    autostart_modal_title: "Conflicto de inicio detectado",
    autostart_modal_body: "El inicio automático Docker de Unraid está activo junto con los scripts UDO. Al arrancar, ambos sistemas intentarán iniciar los contenedores simultáneamente, causando conflictos imprevisibles.",
    autostart_modal_warn: "Se recomienda encarecidamente desactivar el inicio automático de Unraid y dejar que UDO gestione el orden de inicio.",
    autostart_modal_disable: "Desactivar el inicio automático de Unraid",
    autostart_modal_ignore: "Ignorar (no recomendado)",
    autostart_modal_ignore_warn: "⚠ UDO y el inicio automático de Unraid estarán activos simultáneamente. Pueden producirse conflictos en el próximo inicio.",
    autostart_disabled_ok: "Inicio automático de Unraid desactivado correctamente",
  },
  de: {
...
6. LIZENZ
   ...
   https://github.com/Parralex-Labs/Unraid-Docker-Orchestrator`,
    ...
    settings_tab_timeouts: 'Container-Timeouts',
    settings_global_timeout: 'Globaler Timeout (s)',
    settings_boot_delay: 'Boot-Verzögerung (s)',
    settings_abort_on_failure: 'Bei Timeout stoppen',
    settings_log_refresh: 'Log Auto-Refresh (s)',
    settings_collapse_classify: 'Nach Klassifikation einklappen',
    settings_default_pause: 'Pause zwischen Gruppen (s)',
    settings_save: 'Speichern',
    settings_saved: 'Einstellungen gespeichert',
    settings_ct_name: 'Container',
    settings_ct_timeout: 'Timeout (s)',
    settings_ct_add: '+ Hinzufügen',
    settings_ct_detect: '🔍 Aus Logs erkennen',
    settings_ct_detect_none: 'Kein Timeout im letzten Log erkannt.',
    settings_ct_detected: 'Timeout(s) erkannt — Vorschläge unten.',
    tab_logs: '📋 Logs',
    log_viewer_title: 'Skript-Ausführungsprotokolle',
    log_select_start: '🚀 Start',
    log_select_stop: '🛑 Stop',
    log_select_update: '🔄 Update',
    log_btn_refresh: 'Aktualisieren',
    log_btn_clear: 'Leeren',
    log_status_running: 'Läuft...',
    log_status_ok: 'Abgeschlossen',
    log_status_error: 'Mit Fehlern abgeschlossen',
    log_empty: 'Kein Protokoll verfügbar.',
    log_auto_refresh: 'Auto-Aktualisierung',
    ...
    pool_picker_manual: 'Namen manuell eingeben…',
    lbl_stack_compose: 'Compose-Stack: ',
    ...
    dep_picker_title: 'Abhängigkeit wählen',
    dep_picker_search: 'Container suchen...',
    dep_picker_group: 'Gruppe',
    dep_picker_already: 'Bereits eine Abhängigkeit',
    dep_picker_empty: 'Kein Container verfügbar',
    dep_picker_no_results: 'Keine Ergebnisse',
    lbl_db_group: 'Datenbank',
    lbl_hub: 'Abhängigkeitsziel',
    lbl_source: 'Quelle',
    lbl_deps_count_plural: 'Abhängigkeiten',
    lbl_deps_count_singular: 'Abhängigkeit',
    ...
    toggle_allow_db_update_off: 'DB geschützt — Auto-Update deaktiviert (empfohlen)',
    toggle_allow_db_update_on:  'DB — Auto-Update AKTIVIERT (Backup prüfen!),',
    toggle_allow_db_update_hint: 'Automatisches Update dieser Datenbank erlauben',
...
function tGroup(name) {
  ...
  var GROUP_KEY_MAP = {
    autostart_modal_body_container: "1 Container hat seinen Unraid-Autostart einzeln aktiviert.",
    autostart_modal_body_containers: function(n){ return n + " Container haben ihren Unraid-Autostart einzeln aktiviert."; },
    autostart_modal_body_conflict: "Beim Booten versucht Unraid, sie <em>gleichzeitig</em> mit UDO zu starten. Dies führt zu unvorhersehbaren Konflikten.",
    ...
    autostart_modal_title: "Startkonflikt erkannt",
    autostart_modal_body: "Der automatische Docker-Start von Unraid ist zusammen mit den UDO-Skripten aktiv. Beim Booten versuchen beide Systeme gleichzeitig, Ihre Container zu starten, was zu unvorhersehbaren Konflikten führt.",
    autostart_modal_warn: "Es wird dringend empfohlen, den automatischen Unraid-Start zu deaktivieren und UDO die Startreihenfolge allein verwalten zu lassen.",
    autostart_modal_disable: "Automatischen Unraid-Start deaktivieren",
    autostart_modal_ignore: "Ignorieren (nicht empfohlen)",
    autostart_modal_ignore_warn: "⚠ UDO und der automatische Unraid-Start sind gleichzeitig aktiv. Beim nächsten Start können Konflikte auftreten.",
    autostart_disabled_ok: "Automatischer Unraid-Start erfolgreich deaktiviert",
  };
